      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex justify-end">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl h-full bg-[#09090b]/80 backdrop-blur-3xl border-l border-white/10 shadow-2xl flex flex-col"
          >
            {/* Header */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-black text-white flex items-center gap-2">
                    Advanced AI Engine <span className="px-2 py-0.5 rounded-full bg-rose-500/20 text-rose-400 text-[10px] uppercase tracking-widest font-bold">DANGER ZONE</span>
                  </h2>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm font-bold text-white">Auto-Scoring</p>
                  ...
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm font-bold text-white">Auto-Pipeline</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm font-bold text-white">Audio Analysis</p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-white">System Prompt Master</label>
                  ...
                  <textarea 
                    ...
                    className="w-full h-32 bg-black/40 border border-white/10 rounded-xl p-4 text-xs font-mono text-indigo-300 focus:border-indigo-500 outline-none resize-none"
                  />
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-bold text-white">JSON de Critérios de Avaliação (Checklist Dinâmico)</label>
                  <p className="text-xs text-muted-foreground">Defina os pesos de cada etapa para a função <code className="bg-white/10 px-1 rounded">save_lead_audit</code>.</p>
                  <textarea 
                    value={criteria} onChange={e => setCriteria(e.target.value)}
                    className="w-full h-32 bg-black/40 border border-white/10 rounded-xl p-4 text-xs font-mono text-emerald-300 focus:border-emerald-500 outline-none resize-none"
                  />
                </div>
              </div>
            ...
            {/* Footer */}
            <div className="p-6 border-t border-white/10 bg-black/20 backdrop-blur-xl shrink-0 flex items-center justify-between">

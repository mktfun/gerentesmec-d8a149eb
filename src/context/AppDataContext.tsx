...
export const AppDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchInitialData = async () => {
    ...
    const leadsColumns = 'id, customer_name, customer_phone, customer_vehicle, unit_id, manager_id, last_message_at, funnel_stage, score, wait_time_minutes, sla_status, ticket_value, closing_summary, created_at, audit_checklist, audit_reasons, audit_checklist_messages, ai_feedback';
